...
int _tmain(int argc, _TCHAR* argv[])
{
	if (argc != 3)
	{
		cout << "The function requires exactly two arguments, an input and an output file.";
		return 1;
	}
...
91111111111111111111111111111			cout << inPacket.Timestamp << endl;
			...
			if (outFile.is_open())
			{
				...
				outPacket.orig_len = inPacketDataLength+2;	// Get data length as original (include FCS)
